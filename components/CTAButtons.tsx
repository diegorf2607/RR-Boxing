...
/** CTA principal hacia la tienda (antes modal de curso; el curso ya no se ofrece en web). */
export function CourseButton({ variant = 'primary', size = 'md', className = '', children }: CTAButtonProps) {
  ...
  const variantStyles = {
    primary:
      'bg-gradient-to-r from-accent via-yellow-500 to-amber-500 text-dark shadow-lg shadow-accent/30 hover:shadow-accent/50',
