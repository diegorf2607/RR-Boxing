          ...
          {socialStats.map((social, index) => (
            ...
            >
              ...
              <div className="p-3 md:p-4 text-center">
                ...
                <div className={`inline-flex items-center gap-2 md:gap-3 px-4 md:px-5 py-2 rounded-full text-white text-sm md:text-base font-medium mb-2 md:mb-3 ${social.color}`}>
                  <span className="w-5 h-5 md:w-6 md:h-6 flex-shrink-0">{social.icon}</span>
                  <span>{social.handle}</span>
                </div>
                {/* Follower count */}
                <div className="hidden md:block">
                  <p className="text-2xl lg:text-3xl font-bold text-white">{social.followers}</p>
                  <p className="text-sm text-neutral">{social.followersLabel}</p>
                </div>
              </div>
            </Link>
          ))}
