...
export default function HighTicket() {
  return (
    <section id="personalizadas" className="py-20 bg-dark relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-emerald-900/20 via-dark to-teal-900/20"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-teal-500 text-white text-sm font-bold py-2 px-6 rounded-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-dark-100/80 backdrop-blur-sm border border-emerald-500/30 rounded-2xl p-6 text-center hover:border-emerald-500/60 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/10"
            >
        ...
        <div className="max-w-2xl mx-auto">
          <div className="relative">
            {/* Glow effect */}
            <div className="absolute -inset-1 bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 rounded-3xl blur-lg opacity-30"></div>
            
            <div className="relative bg-dark-100 border-2 border-emerald-500/50 rounded-3xl overflow-hidden">
              {/* Header */}
              <div className="bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 text-white text-center py-4">
              ...
              <div className="p-8">
                ...
                <Link
                  ...
                  target="_blank"
                  className="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 hover:from-emerald-400 hover:via-teal-400 hover:to-cyan-400 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl hover:shadow-emerald-500/30 text-lg"
                >
