            ...
            <div className="relative bg-dark-100 border-2 border-red-500/50 rounded-3xl overflow-hidden">
              ...
              <div className="p-5 md:p-8">
                ...
                <Link
                  ...
                  target="_blank"
                  className="w-full flex items-center justify-center gap-2 md:gap-3 bg-gradient-to-r from-red-600 via-red-500 to-orange-500 hover:from-red-500 hover:via-red-400 hover:to-orange-400 text-white font-bold py-3 md:py-4 px-4 md:px-8 rounded-xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl hover:shadow-red-500/30 text-sm md:text-lg"
                >
