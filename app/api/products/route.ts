...
export async function POST(req: Request) {
  ...
  const product: Product = {
    ...
    prices: [
      ...
      { country: 'AR', currency: 'ARS', amount: 38900 },
      { country: 'BO', currency: 'BOB', amount: 220 },
      { country: 'GY', currency: 'GYD', amount: 6800 },
      { country: 'PY', currency: 'PYG', amount: 235000 },
      { country: 'SR', currency: 'SRD', amount: 940 },
      { country: 'UY', currency: 'UYU', amount: 1260 },
